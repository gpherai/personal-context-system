...
Current state: the Command Center can rebuild the mirror, show mirror status, list generated files, show generated bundle variants, and expose system context filters. The generated mirror includes thread detail files and timeline files.
